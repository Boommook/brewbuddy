...
const GLOBAL_INGREDIENTS: SeedIngredient[] = [
  ...
  { name: 'Premier Classique', ingredientType: IngredientType.YEAST, defaultUnit: 'g', brand: 'Red Star' },
  { name: 'Premier Blanc', ingredientType: IngredientType.YEAST, defaultUnit: 'g', brand: 'Red Star' },
  // Yeast — beer / general
  ...
  { name: 'Blueberries (frozen)', ingredientType: IngredientType.FRUIT, defaultUnit: 'lb' },
  { name: 'Blackberries (fresh)', ingredientType: IngredientType.FRUIT, defaultUnit: 'lb' },
  { name: 'Blackberries (frozen)', ingredientType: IngredientType.FRUIT, defaultUnit: 'lb' },
  { name: 'Raspberries (fresh)', ingredientType: IngredientType.FRUIT, defaultUnit: 'lb' },
  { name: 'Raspberries (frozen)', ingredientType: IngredientType.FRUIT, defaultUnit: 'lb' },
  { name: 'Strawberries (fresh)', ingredientType: IngredientType.FRUIT, defaultUnit: 'lb' },
  { name: 'Strawberries (frozen)', ingredientType: IngredientType.FRUIT, defaultUnit: 'lb' },
  { name: 'Cherries (sweet, pitted)', ingredientType: IngredientType.FRUIT, defaultUnit: 'lb' },
  { name: 'Cherries (frozen)', ingredientType: IngredientType.FRUIT, defaultUnit: 'lb' },
  ...
  { name: 'Peaches (frozen)', ingredientType: IngredientType.FRUIT, defaultUnit: 'lb' },
  { name: 'Grape concentrate (wine)', ingredientType: IngredientType.FRUIT, defaultUnit: 'L' },
  { name: 'Orange Peel', ingredientType: IngredientType.FRUIT, defaultUnit: 'oz' },
  { name: 'Lemon Peel', ingredientType: IngredientType.FRUIT, defaultUnit: 'oz' },
  { name: 'Orange Juice', ingredientType: IngredientType.FRUIT, defaultUnit: 'gal' },
  { name: 'Lemon Juice', ingredientType: IngredientType.FRUIT, defaultUnit: 'gal' },
  // Spice
  ...
  { name: 'Lavender (dried)', ingredientType: IngredientType.HERB, defaultUnit: 'g' },
  // Acid
